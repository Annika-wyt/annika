...
class riccati_observer():
    ...
    def visual_plot(self, figsize = (20, 4), bound_y=True):
        ...
        '''
        scipy_solution = pd.read_csv('/home/annika/ITRL/kth_thesis/simulated_result/ricatti_solution_for_100s_step_1e-3_rtol_atol_1e-9_eq' + str(self.which_eq) + '.txt', header=None)
